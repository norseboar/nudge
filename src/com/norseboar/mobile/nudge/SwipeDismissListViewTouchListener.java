...
// lifted from https://github.com/romannurik/Android-SwipeToDismiss/tree/master/src/com/example/android/swipedismiss
public class SwipeDismissListViewTouchListener implements View.OnTouchListener {
    ...
    // added to stock template to provide an adapter and de-interface it
    private NudgeEntryAdapter adapter;
     ...
     */
    public SwipeDismissListViewTouchListener(ListView listView, NudgeEntryAdapter adapter) {
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mDismissAnimationRefCount == 0) {
                    ...
                    onDismiss(mListView, dismissPositions);
